...
(function () {
  ...
  const translations = {
    hy: {
      ...
      "schedule.brideAddr": "գյուղ Գեղանիստ, Արարատ · 10-րդ փողոց, 52 տուն",
    ...
    ru: {
      ...
      "schedule.brideAddr": "село Геганист, Арарат · 10-я улица, дом 52",
    ...
    en: {
      ...
      "schedule.brideAddr": "Geghanist village, Ararat · 10th Street, house 52",
